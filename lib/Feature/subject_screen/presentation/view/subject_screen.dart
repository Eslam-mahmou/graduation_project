...
import 'package:graduation_project/Feature/subject_screen/presentation/manager/user_view_model.dart';
...
class SubjectScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => viewModel..fetchUser(),
      child: BlocConsumer<UserViewModel, UserState>(
